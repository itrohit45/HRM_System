    ...
    return(
        <div> <br/>
             <center>
                <h1>Login</h1>
                <br/>
                <div className='container mt-5 shadow-lg border border-success' style={{width:380, borderRadius:10, height:230, background: 'linear-gradient( rgb(248, 168, 182), rgb(154, 154, 250))'}}>
