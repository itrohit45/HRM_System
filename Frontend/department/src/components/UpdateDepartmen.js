...
function UpdateDepartment(){
  ...
  return(
    ...
    <br/>
      ...
      <br/>
      <center>
      <div style={{width: 400, borderRadius:10, height: 220}} className='container mt-5 shadow-lg border border-success'>
...
<div className="mb-3" style={{width: 300}}>
  ...
  <input type="text" className="form-control" required name="department_description" value={department.department_description} onChange={handleChange}/>
</div>
